...
opt.input_file = 'TopoData_20190106_02_002';
opt.output_folder = '/data/picked layers/06_02';
...
opt.picker = 'Inka Koch';
opt.frequency = 'MCoRDS';
opt.date = date;
...
tp.smooth_sur=10;             % between 30 and 60 seems to be good
