...
opt.input_folder = '../../../data/rd_group/Radar/ReMeltRadar/Proc_PE/';
opt.input_file = 'kotta250_2';
opt.output_folder = '../../../data/rd_group/Radar/ReMeltRadar/Proc_PE/picks/'; % Relative or absolue path
...
opt.metadata_folder = '../../../data/rd_group/Radar/ReMeltRadar/Proc_PE/picks/metadata/';
...
opt.update_seeds = 0;       % Update bottom, when old geoinfo is loaded.
...
opt.find_maxima = 1;        % If activated, maxima are picked. Otherwise minima are picked. 
...
tp.MinBinForBottomPick = 5000;
tp.MaxBinForBottomPick = 8300;
tp.num_bottom_peaks = 3;      % Number of strongest peaks considered as bottom pick. 10 is a good guess.
tp.smooth_bot = 0;              % Smoothing for bottom pick. No smoothing for smooth_bot 

% For computation of seeds (Only possible for MCoRDS-data)
tp.window = 15;                  %vertical window, keep small to avoid jumping. Even numbers work as next odd number.
