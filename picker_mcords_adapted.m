...
opt.input_folder = '/data/example_leah_MCoRDS/';
opt.input_file = 'TopoallData_20190107_01_006.mat';
opt.output_folder = '/data/example_leah_MCoRDS';
opt.output_prefix = '/LayerData_'; % Define a prefix for the layerdata-file. (output_file = prefix + suffix)
opt.output_suffix = '07_01_006'; % Define a suffix for the layerdata-file.
