...
opt.input_file = '\TopoallData_20190107_01_003';
opt.output_folder = '\data\picked_mcords';
opt.output_prefix = '\LayerData_07_01'; % Define a prefix for the layerdata-file. (output_file = prefix + suffix)
opt.output_suffix = '003'; % Define a suffix for the layerdata-file.
